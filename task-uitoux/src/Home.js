...
export default function Home() {
  return (
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="assets/images/slide-1.jpeg" class="d-block w-100 image-carousal-1" alt="..." />
              </div>
              <div class="carousel-item">
                <img src="assets/images/slide-1.jpeg" class="d-block w-100 image-carousal-1" alt="no-img" />
              </div>
              <div class="carousel-item">
                <img src="assets/images/slide-1.jpeg" class="d-block w-100 image-carousal-1" alt="..." />
              </div>
    ...
    <div>
          ...
          <div class="container">
     <div class="head">
        <h1 class="head1">30% OFF</h1>
    </div>
    <h1 class="para">When Buying Parts<br /> With Installation</h1>
    ...
    <div class="d-flex flex-row justify-content-center">
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img  alt="no-img" src="assets/images/product-1.jpeg" class="card-img-1" />
            </div>
        ...
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img alt="no-img" src="assets/images/product-2.jpeg" class="card-img-1" />
            </div>
        ...
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img alt="no-img" src="assets/images/product-3.jpeg" class="card-img-1" />
            </div>
        ...
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img alt="no-img" src="assets/images/product-4.jpeg" class="card-img-1" />
            </div>
        ...
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img alt="no-img" src="assets/images/product-5.jpeg" class="card-img-1" />
            </div>
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3">
        <div>
            <img alt="no-img" src="assets/images/product-6.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-img" src="assets/images/product-7.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-img" src="assets/images/product-8.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
...
<div>
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-img" src="assets/images/product-9.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-img" src="assets/images/product-10.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-img" src="assets/images/product-11.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
...
<div>
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-img" src="assets/images/product-12.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
                Brandix Manual Five Speed Gearbox
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-img" src="assets/images/product-13.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
    ...
    <div>
        ...
        <div class="bg-color d-flex flex-row pt-5">
          ...
          <div class="input-group mb-3">
            ...
            <img  src="assets/images/facebook.png" alt="no-img"/>
            <img  src="assets/images/twitter.png" alt="no-img"/>
            <img  src="assets/images/youtube1.png" alt="no-img"/>
            <img  src="assets/images/insta.png" alt="no-img"/>
            <img  src="assets/images/rss.png" alt="no-img"/>
        </div>
